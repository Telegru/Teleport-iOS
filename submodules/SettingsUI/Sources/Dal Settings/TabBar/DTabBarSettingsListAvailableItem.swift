...
final class DTabBarSettingsListAvailableItem: ListViewItem, ItemListItem {
    ...
    func nodeConfiguredForParams(
        ...
        async {
            let node = DTabBarSettingsListAvailableItemNode()
    ...
    func updateNode(
        ...
        Queue.mainQueue().async {
            if let nodeValue = node() as? DTabBarSettingsListAvailableItemNode {
...
final class DTabBarSettingsListAvailableItemNode: ListViewItemNode, ItemListItemNode {
    ...
    private var item: DTabBarSettingsListAvailableItem?
    ...
    func asyncLayout() -> (_ item: DTabBarSettingsListAvailableItem, _ params: ListViewItemLayoutParams, _ insets: ItemListNeighbors) -> (ListViewItemNodeLayout, () -> Void) {
        ...
        return { item, params, neighbors in
            ...
            let height: CGFloat
            height = verticalInset * 2.0 + titleLayout.size.height + titleSpacing

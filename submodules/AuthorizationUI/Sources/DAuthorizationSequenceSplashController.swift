...
public final class DAuthorizationSequenceSplashController: ViewController {
    ...
    init(accountManager: AccountManager<TelegramAccountManagerTypes>, account: UnauthorizedAccount, theme: PresentationTheme) {
        ...
        self.startButton = SolidRoundedButtonNode(title: "Intro.StartMessaging".tp_loc(), theme: SolidRoundedButtonTheme(backgroundColor: UIColor(hexString: "#7B86C3")!, foregroundColor: .white), height: 50.0, cornerRadius: 13.0, gloss: true)
        ...
        self.controller.createStartButton = { [weak self] width in
            ...
            return self?.startButton.view ?? UIView()
        }
    }

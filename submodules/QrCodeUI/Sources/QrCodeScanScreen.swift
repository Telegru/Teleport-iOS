...
public final class QrCodeScanScreen: ViewController {
    ...
    public init(context: AccountContext, subject: QrCodeScanScreen.Subject) {
        ...
        let navigationBarTheme = NavigationBarTheme(buttonColor: .white, disabledButtonColor: .white, primaryTextColor: .white, backgroundColor: .clear, enableBackgroundBlur: false, separatorColor: .clear, badgeBackgroundColor: .clear, badgeStrokeColor: .clear, badgeTextColor: .clear, squareStyle: presentationData.theme.squareStyle)
